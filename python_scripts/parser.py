...
def get_args():
    ...
    parser.add_argument('-DB', type = str, default = '/media/draco/NeuralNetwork/CSE499/Datasets/VoxCeleb1/')
    ...
    parser.add_argument('-load_model_dir', type = str, default = 'out/rawnet2_vox2/models/model_3.pt')
    parser.add_argument('-load_model_opt_dir', type = str, default = 'out/rawnet2_vox2/models/opt_3.pt')
